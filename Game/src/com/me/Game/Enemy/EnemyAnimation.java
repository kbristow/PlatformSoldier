...
public class EnemyAnimation extends GameObject {
	...
	ArmFSMState currentStateArm;
	LegFSMState currentStateLeg;
	...
	public void updateAnimations(boolean isDead, boolean isGrounded, boolean isHit, boolean isMouseDown, float hSpeed){
		...
		/*if (currentStateArm.state == ArmState.ATTACK && currentStateArm.isNewState){
			swordAttachment.currentState = WeaponState.ATTACK;
			swordAttachment.resetAttackArray();
		}
		else if (currentStateArm.state != ArmState.ATTACK){
