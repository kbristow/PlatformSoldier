...
import com.me.Game.Player.PlayerAnimation;
...
public class PlayerControl extends GameObjectDestroyable{
	...
	public void onCreate(){
        ...
        playerAnimations = new PlayerAnimation();
    ...
    private void controlAttachments(){
    	...
    	playerAnimations.manualUpdatePre(false, isGrounded, false, isMouseDown, hSpeed);
    }
